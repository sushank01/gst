...
import { createLeaveType, listLeaveTypes } from '../../../../../../server/services/leave.ts'
...
export const GET = tenantRoute(async ({ ctx }) => {
  ...
  return { body: { leaveTypes: await listLeaveTypes(ctx), departments: await listVocabulary(ctx, 'department') } }
})
